 ...
 * @version 1.0, 10/10/2011 <li>Creation</li>
 */
        ...
        try {
            ...
            for (int indArg = 0; indArg < args.length; indArg++) {
                ...
                if (indMand < nbMandatoryArgs) {
                    if (args[indArg].startsWith("-")) { throw new SimpleException("exception.ChecksumMD5.syntax"); }
            ...
            if (indMand != nbMandatoryArgs) { throw new SimpleException("exception.ChecksumMD5.syntax"); }
